...
import { TransactionalQueue, QueueLockError, PoisonMessageDetector, AdaptiveThrottler, NetworkQualityDetector } from '../../src/lib/transactionalQueue';
...
describe('TransactionalQueue Chaos Tests', () => {
  ...
  it('should move poison messages to dead letter queue', async () => {
    ...
    // Wait for max attempts (2 cycles × ~100ms each)
