...
import { Plus, Trash2, ShoppingBag, Zap, DollarSign, AlertTriangle } from 'lucide-react';
import { cn } from '../../utils/cn';

const SalesView = () => {
    const { items, getTotals, clearCart, addItem, validateStock, checkoutId, generateCheckoutId } = useCartStore();
    ...
    const handleCheckout = async (paymentData) => {
        ...
        try {
            ...
            setPayError('Error al procesar la venta: ' + e.message);
            setProcessing(false);
            throw e;
        }
    };
    ...
    return (
        <div className="h-[calc(100vh-80px)] flex gap-4 p-2 overflow-hidden bg-[var(--bg)]">
            ...
            <div className="w-[450px] flex flex-col bg-[var(--card)] border border-[var(--border)] rounded-2xl shadow-xl h-full overflow-hidden">
                ...
                {payError && (
                    <div className="px-6 py-3 bg-red-50 border-t-2 border-red-200 flex items-center gap-2">
