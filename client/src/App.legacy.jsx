...
const VentasView = React.lazy(() => import('./views/Ventas'))
const ReportesView = React.lazy(() => import('./views/Reportes'))
...
import { IconVentas, IconProductos, IconClientes, IconConfig, IconReportes, IconInfo } from './components/ui/icons'
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/ventas" element={<div className="route-enter"><VentasView /></div>} />
