...
export function StatusIndicator({ variant, label, pulse = true, size = 'md', className }: StatusIndicatorProps) {
  ...
  return (
    <div className={cn('inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full border font-bold', cfg.bg, cfg.border, cfg.text, size === 'sm' ? 'text-[9px]' : 'text-[10px]', className)}>
